...
(chech also these files: ~/.config/pipewire/pipewire.conf, ~/.config/pipewire/pipewire-pulse.conf and ~/.config/wireplumber/main.lua.d/50-alsa-config

Restart the pipewire daemon with: systemctl --user restart wireplumber pipewire pipewire-pulse
